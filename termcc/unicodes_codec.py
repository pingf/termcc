...
__all__ = ['TERMCC_UNICODE', 'UNICODE_TERMCC', 'TERMCC_ALIAS_UNICODE', 'UNICODE_TERMCC_ALIAS']
...
TERMCC_ALIAS_UNICODE = dict(TERMCC_UNICODE.items(), **{
u':admission_tickets:': u'\U0001F39F',
    u':aerial_tramway:': u'\U0001F6A1',
    u':airplane:': u'\U00002708',
...
TERMCC_UNICODE.update(CC)
TERMCC_ALIAS_UNICODE.update(CC)

UNICODE_TERMCC = {v: k for k, v in TERMCC_UNICODE.items()}
UNICODE_TERMCC_ALIAS = {v: k for k, v in TERMCC_ALIAS_UNICODE.items()}
